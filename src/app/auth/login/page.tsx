      ...
      <div className="hidden bg-zinc-900 text-white h-full p-10 w-screen justify-center lg:flex lg:flex-col lg:justify-between lg:w-2/4">
        ...
        <>
          <blockquote className="space-y-2">
            <p className="text-lg">
              &ldquo;You put water into a bottle, it becomes the bottle. You put it in a teapot, it
              becomes the teapot. Water can flow, or it can crash. Be water, my friend.&rdquo;
            </p>
